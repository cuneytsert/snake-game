...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
% This is the 14th version of our snake game. Please have a look at the   %
% previous versions before this one.                                      %
%                                                                         %
% In this version our snake speeds up as it eats food. This makes the     %
% game more challenging and fun. Also the numbers on the axes are         %
% removed.                                                                %
%                                                                         %
...
speedUpFactor = 0.01;  % How much the pauseAmount will increase when a food is eaten.

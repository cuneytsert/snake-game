...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
% This is the 17th version of our snake game. Please have a look at the   %
% previous versions before this one.                                      %
%                                                                         %
% In this version we correct a bug. When a new food position is           %
% calculated, we now make sure that it is not under one of the squares    %
% occupied by the snake. For this, we created a new function called       %
% calcFoodCoord which is called by startGame and moveSnake functions.     %
%                                                                         %

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
% This is the 20th version of our snake game. Please have a look at the   %
% previous versions before this one.                                      %
%                                                                         %
% In this version we added a fun visual effect when the game ends. When   %
% the snake hits a wall or itself, its color gradually changes from head  %
% to tail. This is done by a new function called deadAnimation. A new     %
% variable called colors is introduced for storing the colors of snake's  %
% head, snake's body, food and dead snake.                                %
%                                                                         %
...
colors = ["#261CC1"; "#3A9AFF"; "#EB4C4C"; "#DDDDDD"];   % Colors for snake's head, snake's
                                                         % body food and the dead snake
% **************
% CHANGES END
% **************
...
global width height snakeCoord snake len isGameOver direction score ...
       foodCoord food pauseAmount pauseAmountMin pauseAmountMax ...
       gameOverText colors
...
for i=1:len
    ...
    %pause((0.1*i+0.1-0.2*len)/(1-len));
    pause((0.15*i+0.05-0.2*len)/(1-len));
end

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
% This is the 9th version of our snake game. Please have a look at the    %
% previous versions before this one.                                      %
%                                                                         %
% In this version we divide the code into three functions, the main       %
% function, the startGame function and the moveSnake function. We also    %
% start using a flag variable called isGameOver to keep track of the      %
% status of the game. We define many of the variables as "global" to use  %
% them in multiple functions. Using global variables a lot (instead of    %
% passing local variables to functions as arguments) is not an advised    %
% practice in general. But this is a small code written for fun, and      %
% there are no security concerns or anything like that. No nuclear weapon %
% will be fired if something goes wrong :-)                               %
%                                                                         %
...
% To randomize the food's location, we will MATLAB's built-in randi function.

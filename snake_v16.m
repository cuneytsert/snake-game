...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
% This is the 16th version of our snake game. Please have a look at the   %
% previous versions before this one.                                      %
%                                                                         %
% In this version we can restart the game by pressing the spacebar when   %
% it ends. This makes it easier to play several games one after the       %
% other. Introduced a new flag variable called wantToQuit, which becomes  %
% TRUE if the player wants to close the game window, and this how the     %
% game loop terminates. A new function called closeWindow is added which  %
% is called when the user clicks the close button at the top right corner %
% of the game window.                                                     %
%                                                                         %
...
% It is terminated when wantToQuit becomes TRUE which happens when the user
...
disp("Pause/continue/restart with the spacebar.")
...
% Called when the user presses the Cclose button of the figure window
